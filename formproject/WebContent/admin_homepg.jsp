					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="adminviewevents.jsp" class="active">VIEW EVENT</a></li>
								<li><a href="admin_verifyevent.jsp" class="active">VERIFY EVENT</a></li>
		...
		<div class="w3ls-heading">
					...
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
							<a href="adminprincipalapptview.jsp"><i class="fa fa-lightbulb-o" aria-hidden="true"></i></a>
						</div>
						<div class="services-icon-info">
						<a href="adminprincipalapptview.jsp">	
							<h5>VIEW PRINCIPAL APPOINTMENT</h5></a>
							<p></p>
						</div>
					</div>
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
						<a href="adminviewevents.jsp">
						<i class="fa fa-question-circle-o" aria-hidden="true"></i></a>
						</div>
						<div class="services-icon-info">
						<a href="adminviewevents.jsp">	
							<h5>VIEW/UPDATE EVENTS</h5></a>
							<p></p>
						</div>
					</div>
					<div class="clearfix"> </div>
