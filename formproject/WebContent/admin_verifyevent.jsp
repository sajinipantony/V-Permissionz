					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="adminsearchtime.jsp" class="active">UPDATE  TIMESHEET</a></li>						
...
<div class="contact" id="contact">
		<div class="container">
			<div class="w3ls-heading">
				<h3><font color="red"> VIEW EVENT REQUEST</font></h3>
...
ResultSet rs=null;
	...
	rs=st.executeQuery("select * from event where status='"+stat+"' ");
	while(rs.next())
	{
		id1=rs.getInt(1);
		id=rs.getString(1);
...
<td width="300px" ><center><font color="red"></font></center></td>
	...
	<td width="300px" ><div ><a href="admineventapprove.jsp?<%=id%>"><font  color="green"  size="+1" face="Times New Roman, Times, serif" > 
    Approve </font></a></div></td>
	<td width="300px" ><div ><a href="admineventreject.jsp?<%=id%>"><font  color="red"  size="+1" face="Times New Roman, Times, serif" > 
