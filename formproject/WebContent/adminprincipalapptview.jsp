...
<div class="contact" id="contact">
		<div class="container">
			<div class="w3ls-heading">
				<h3><font color="red"> View Appointments</font></h3>
...
<td width="300px"><center><font color="red">TIME</font></center></td>
...
try{
	...
	rs=st.executeQuery("select * from appointment where status='"+status+"' or status='"+"approved"+"'");
	while(rs.next())
	{
		id=rs.getString(1);
	...
	//	price=rs.getDouble(7);
		...
		<td width="300px"><%=time%></td>
				...
				<td><div ><a href="appointmentapprove.jsp?<%=id%> "><font  color="green"  face="Times New Roman, Times, serif" > 
                Approve </font></a></div></td>
				<td><div ><a href="appointmentreject.jsp?<%=id%>"><font  color="red"   face="Times New Roman, Times, serif" > 
                Reject </font></a></div></td>
