...
<div class="contact" id="contact">
		<div class="container">
			<div class="w3ls-heading">
				<h3><font color="red">UPDATE APPOINTMENT STATUS</font></h3>
				
			</div>
			<div class="w3layouts-grids">
				
				<div class="col-md-8 contact-form">
					<form action="appointmentupdate" method="get">
...
ResultSet rs=null;
	...
	<font color="red">	First Name :: </font>
		<br>
		<input type="text" class="phone"  name="fname"  required="" value="<%=fname %>">
				<font color="red">	Last Name : </font>
		<br>
		
					<input type="text" class="phone"  name="lname"  required="" value="<%=lname %>">
					<font color="red">Department:	</font>
		<br>
						<textarea placeholder="Department" name="dep" required=""><%=dept %></textarea>
						<br><br>
				<font color="red">Date: </font>
		<br>
					<input type="text" class="phone" name="date" required="" value="<%=date %>">
						<br><br>
						<font color="red">	Time: </font>
		<br>
					<input type="text" class="phone" name="time" required="" value="<%=time %>">
							<br><br>
							<font color="red">	Date : </font>
		<br>
						<input type="tel" pattern="[789][0-9]{9}" class="phone" name="date"  required="" value="<%=purpose %>">
