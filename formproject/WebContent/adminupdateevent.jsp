...
ResultSet rs=null;
	...
	rs=st.executeQuery("select * from event where id='"+id+"' and status='"+status+"' ");
	while(rs.next())
	{
	...
	//	price=rs.getDouble(7);
		...
		%>		
						...
						<div class="clearfix"> </div>	
							<input type="hidden" class="phone" name="id1" placeholder="Event Name" required="" value="<%=id %>">
										
						<input type="text" class="phone" name="event" placeholder="Event Name" required="" value="<%=event %>">
						<br><br>
						<input type="text" class="phone" name="place" placeholder="Place" required="" value="<%=place %>">
						<br><br>
				...
				<form action="admin_del_event" method="post" a >
