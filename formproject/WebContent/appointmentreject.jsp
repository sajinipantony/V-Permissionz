...
//String name=session.getAttribute("username").toString();	
	...
	PreparedStatement ps=con.prepareStatement("update appointment set status='rejected' where id='"+id+"' ");
...
%>
<br><p> Event Rejected</p>
</div>
<% 
response.sendRedirect("adminprincipalapptview.jsp");
}
catch(Exception e1)
{
