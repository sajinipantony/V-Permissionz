...
<div class="contact" id="contact">
		<div class="container">
			<div class="w3ls-heading">
				<h3> <font color="red">ADD NEW EVENTS DETAILS</font></h3>
				<p class="sub"></p>
			</div>
			<div class="w3layouts-grids">
				<div class="col-md-8 contact-form">
				
					<form action="deptaddevents" method="post"  enctype= multipart/form-data >
						<table width="1200px">
						<div class="clearfix"> </div>	
						<tr height = "75px">
						<td><label>EVENT NAME: </label></td>
						<td><input name="eventname"	id="eventname" placeholder=" Add eventname"></td></tr>		
						...
						<tr height = "75px">
						<td width="100px"><label >CHOOSE HALL:</label></td>
						<td width="100px"><select id="hall" name="hallname">
<option value="LISSUEX">LISSUEX HALL</option>
<option value="AUDITORIUM">AUDITORIUM</option>
<option value="CHOMSKY">CHOMSKY</option>
<option value="SILVERJUBLEE">SILVER JUBLEE HALL</option>
<option value="SEMINARHALL">SEMINAR HALL</option>
</select><br><br></td>
<td width="100px"><a href="showavailability.jsp">Show Hall Availability</a></td></tr>
						<tr>
						<td><label for="dep">DEPARTMENT/CLUB</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<td><label>PERSON IN-CHARGE: </label></td>
						<td><input type="text" name="inchargename">
						</td>
						</tr>
<tr><td>Select Image  </td>
						<td><input type="file"   name="myfile" ></td></tr>

<tr><td><label>About the event:</label></td>
