					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="clubdeptviewevent.jsp" class="active">View Events</a></li>
								<li><a href="clubdeptviewleaveform.jsp" class="active">View Leave Request</a></li>
								<li><a href="clubdeptviewoutpass.jsp" class="active">VIEW OutPass Request</a></li>
		...
		<div class="w3ls-heading">
			...
			<div class="w3layouts-grids">
				<div class="services-right-grids">
					...
					<a href="clubdeptaddevent.jsp">		<i class="fa fa-file-text-o" aria-hidden="true"></i></a>
						</div>
						<div class="services-icon-info">
						<a href="clubdeptaddevent.jsp">	<h5>Add Event</h5></a>
							<p></p>
						</div>
					</div>
