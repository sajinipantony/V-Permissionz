...
<div class="contact" id="contact">
		<div class="container">
			<div class="w3ls-heading">
				<h3><font color="red"> View Approved Events</font></h3>
...
try{
	...
	rs=st.executeQuery("select * from event where cdeptname='"+dept1+"' and status='"+"approved"+"' ");
	while(rs.next())
	{
		id=rs.getString(1);
...
<td><img alt="" width="200px" src="clubviewevent?id=<%=id%>" > 
 </td> 
