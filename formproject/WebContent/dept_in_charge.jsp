...
<div class="header-w3ls-agileinfo">
			...
			<div class="wthree_agile_top_header">
				<div class="logo-agileits">
					<h1><a href="hod_homepge.jsp"><span>A</span>NNS COLLEGE OF TECHNICAL ENGINEERING <i class="fa fa-graduation-cap" aria-hidden="true"></i></a></h1>
				</div>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<nav>
								...
								<li class="active" ><a href="hod_homepge.jsp">Home</a></li>								
								<li ><a href="hod_add_teachers.jsp" class="active">ADD TEACHER</a></li>
								<li><a href="hod_view_teachers.jsp" class="active">VIEW TEACHERS</a></li>
								<li><a href="hod_add_notifications.jsp" class="active">ADD NOTIFICATIONS</a></li>
							<li><a href="hod_view_notifications.jsp" class="active">VIEW NOTIFICATIONS</a></li>
							<li><a href="hod_update_profile.jsp" class="active">Profile</a></li>
							<li><a href="hod_update_pwd.jsp" class="active">change password</a></li>
