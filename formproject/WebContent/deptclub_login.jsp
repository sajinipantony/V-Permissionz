					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="management.jsp" class="active">Management</a></li>
								<li><a href="department and Clubs.jsp" class="active">Departments</a></li>
								<li><a href="gallery.jsp" class="active">Gallery</a></li>
								<li><a href="placement.jsp" class="active">Placement cell</a></li>
								<li><a href="facilities.jsp" class="active">facilities</a></li>
								<li><a href="course.jsp" class="active">courses offered</a></li>
																...
																<div class="modal-header">
																	...
																	<h3 class="agileinfo_sign">Sign In</h3>	
																			<div class="login-form">
																				<form action="loginclubs" method="post">
																				<select style="width: 535px;height: 45px" name="role"><option >Select_Category
								<option>ADMIN
								<option>HOD
								<option >TEACHERS
								<option >PARENTS        
								<option > STUDENTS        </select>
...
<!-- banner-down-->
		...
		<div class="container">
			<div class="w3ls-heading">
				<h3><font color="red"> PLACED STUDENTS </font></h3>
				<p class="sub"></p>
			</div>
			<div>
			<br>
            ...
            <img alt="" src="img/a.jpg" height="200px" >
           <img alt="" src="img/b.jpg" height="200px" >
           <img alt="" src="img/c.jpg" height="200px" >
           <img alt="" src="img/d.jpg" height="200px" >
           <img alt="" src="img/e.jpg" height="200px" >
           <img alt="" src="img/f.jpg" height="200px" >
           <img alt="" src="img/g.jpg" height="200px" >
           <img alt="" src="img/h.jpg" height="200px" >
           <img alt="" src="img/i.jpg" height="200px" >
           <img alt="" src="img/j.jpg" height="200px" >
           <img alt="" src="img/k.jpg" height="200px" >
           <img alt="" src="img/l.jpg" height="200px" >
           <img alt="" src="img/m.jpg" height="200px" >
	...
	<div class="banner-bottom-agileits" id="about">
			...
			<div class="col-md-5 w3l_banner_bottom_right">
				...
				<img src="" alt="" width="1500" height="250">
		         ...
		         <img src="img/sd.jpg" alt="" width="1180" height="500" style="margin-left: 100px">
		...
		<div class="container">
			<div class="w3ls-heading">
				<h3><font color="red">RECRUITMENT & SELECTION</font></h3>
				<p class="sub">Managing Diversity and Equal Opportunity</p>
			</div>
			<div>
			<br>
			...
			<img alt="" src="img/1.jpeg" height="150px" >
			<img alt="" src="img/2.png" height="150px">
			<img alt="" src="img/3.jpg" height="150px">
			<img alt="" src="img/4.jpg" height="150px">
			<img alt="" src="img/5.png" height="150px">
			<img alt="" src="img/6.png" height="150px">
			<img alt="" src="img/7.jpg" height="150px">
			<img alt="" src="img/8.png" height="150px">
			<img alt="" src="img/9.png" height="150px">
			<img alt="" src="img/10.jpg" height="150px">
			<img alt="" src="img/11.jpg" height="150px">
			<img alt="" src="img/12.jpg" height="150px">
			<img alt="" src="img/13.jpg" height="150px">
			<img alt="" src="img/14.jpg" height="150px">
	
			</marquee>
			<p><font size="4px">
							<i>" Quis autem vel eum iure reprehenderit qui in ea voluptate velit .Ut enim ad minima veniam, quis nostrum 
							exercitationem ullam corporis suscipit laboriosam, 
							nisi ut aliquid ex ea commodi consequatur.
							<i>" Quis autem vel eum iure reprehenderit qui in ea voluptate velit .Ut enim ad minima veniam, quis nostrum 
							exercitationem ullam corporis suscipit laboriosam, 
							...
							exercitationem ullam corporis suscipit laboriosam, 
							nisi ut aliquid ex ea commodi consequatur.
							<i>" Quis autem vel eum iure reprehenderit qui in ea voluptate velit .</font>
			</div>
			<div class="col-md-5 w3l_banner_bottom_right">
				
				<img src="img/.jpg" alt="" width="1350" height="250">
				<br>
		         <img src="img/.jpg" alt="" width="1350" height="250">
			...
			<div class="footer-top">
				<div class="col-md-4 ftr-grid fg2">
					...
					<div class="right-w3-2">
						<ul class="text-w3">
							<li><a href="">ANNS Engineering College</a></li>
							<li><a href="">Navi Mumbai</a></li>
							<li><a href="">Palhora city</a></li>
							<li><a href="">Maharashtra State,India</a></li>
				...
				<div class="col-md-4 ftr-grid fg2 mid-gd">
					...
					<div class="ftr-address">
						<div class="ftr-text">
							<p>&nbsp&nbsp&nbsp +1 (512) 154 8176</p>
						</div>
						<div class="ftr-text">
							<p>&nbsp&nbsp&nbsp +1 (512) 154 8175</p>
						</div>
						<div class="clearfix"> </div>
					</div>
				...
				<div class="col-md-4 ftr-grid fg2">
					...
					<div class="right-w3-2">
						<ul class="text-w3">
							...
							<li><a href="">&nbsp&nbsp&nbsp anns@gmail.com</a></li>
							<li><a href="">&nbsp&nbsp&nbsp anns@yahoo.com</a></li>
							<li><a href=""></a></li>
						</ul>
					</div>
				</div>
