...
<html lang="en">
<head>
<title>V-Permissionz An Education Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
...
<!-- //bootstrap-pop-up -->
            ...
            <img alt="" src="images/g5.jpg" height="200px" >
           <img alt="" src="images/g8.jpg" height="200px" >
           <img alt="" src="images/vimala1.jpg" height="200px" >
           <img alt="" src="images/vimala2.jpg" height="200px" >
...
<!-- banner-bottom -->
	<div class="banner-bottom-agileits" id="about">
			...
			<div class="col-md-5 w3l_banner_bottom_right">
				...
				<img src="images/g8.jpg" alt="" width="1500" height="250">
				
		         <img src="images/g5.jpg" alt="" width="1180" height="500" style="margin-left: 100px">
			...
			<img alt="" src="images/vimala3.jpg" height="150px">
...
<h3>Locate Us</h3>
 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3922.3329491396303!2d76.22466451479885!3d10.553097492473304!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba7ef1d21ab52ed%3A0x740c75580f212fa6!2sVimala+College!5e0!3m2!1sen!2sin!4v1504244557707" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen=""></iframe>
			...
			<div class="col-md-5 w3l_banner_bottom_right">
				...
				<br>
		         <img src="images/vimala4.jfif" alt="" width="500" height="250">
		...
		<div class="footer-main">
			<div class="footer-top">
				...
				<div class="col-md-4 ftr-grid fg2 mid-gd">
					...
					<div class="ftr-address">
						<div class="ftr-text">
							<p>&nbsp&nbsp&nbsp +0487 233 2080</p>
						</div>
						<div class="ftr-text">
							<p>&nbsp&nbsp&nbsp +0487 233 2080</p>
						</div>
				...
				<div class="col-md-4 ftr-grid fg2">
					...
					<div class="right-w3-2">
						<ul class="text-w3">
							...
							<li><a href="">&nbsp&nbsp&nbsp vimala@gmail.com</a></li>
							<li><a href="">&nbsp&nbsp&nbsp vimala@yahoo.com</a></li>
							<li><a href=""></a></li>
						</ul>
					</div>
				</div>
			...
			<div class="copyrights">
				<p>&copy; 2017 Vimala. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
			</div>
		</div>
	</div>
