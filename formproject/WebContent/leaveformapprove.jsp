...
//String name=session.getAttribute("username").toString();	
	...
	PreparedStatement ps=con.prepareStatement("update leaveform set status='approved' where id='"+id+"' ");
...
%>
<br><p> Leave Approved</p>
</div>
<% 
response.sendRedirect("clubdeptviewleaveform.jsp");
}
catch(Exception e1)
{
