...
<!-- header -->
	<div class="header-w3ls-agileinfo">
			...
			<br>
	<br><br>Many are Called, but only a few are chosen, says the Scripture. If a   teacher can see eternity in an hour of class, she engages….if a student realizes how privileged she is to bethus instructed… they belong to the citizenship of the Chosen. Chosen does not mean You are meant for lofty and noble tasks alone.

<br> <br>
<br>
<br>As Martin Luther King observed,
...
<br>
<br>
<br>Dear Vimalites, this is exactly what I hope for you. Your days here should equip you with all the skills that one needs to contribute to holistic development of an individual and also emerge victorious a midst all trials and tribulations. As the butterfly comes out of the chrysalis, let all of you be adorned with flying colours.

<br>
<br>
<br>May the thousands of smiles that have illumined the corridors of Vimala can prove to be a solace to the world like tiny droplets on parched earth.
