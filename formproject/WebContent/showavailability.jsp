...
<div class="container">
<form class="form-inline" method="post" action="searchhall.jsp">
...
<table>
<tr>
<td><label >Select HallName:</label></td>
						<td><select id="hall" name="hallname">
...
<tr>
<td><button type="submit" name="save" class="btn btn-primary">Search</button></td>
</tr>
</table>
</form>
</div>
