...
<div class="contact" id="contact">
	...
	%>
	<center>	<label style="font-size: 6;color: blue"><%=msg %> </label></center>
				
<font color="red">Current Password	: </font>
	
		<br>
		<input type="password" class="phone" name="cur_pwd" placeholder="Current Password" required="" ">
		<br><br>
				<font color="red">New Password	: </font>
		<br>
		
					<input type="password" class="phone" name="new_pwd" placeholder="New Password" required="" >
					<br><br>
					<font color="red">	Confirm Password : </font>
		<br>
			
					<input type="password" class="phone" name="con_pwd" placeholder="Confirm Password" required="" >
