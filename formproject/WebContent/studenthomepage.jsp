		...
		<div class="w3ls-heading">
			...
			<div class="w3layouts-grids">
				<div class="services-right-grids">
					...
					<a href="studentapplyappt.jsp">		<i class="fa fa-bar-chart" aria-hidden="true"></i></a>
						</div>
						<div class="services-icon-info">
						<a href="studentapplyappt.jsp">	<h5>Apply Principal Appointment</h5></a>
							<p></p>
						</div>
					</div>
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
							<a href="studentleaveform.jsp"><i class="fa fa-lightbulb-o" aria-hidden="true"></i></a>
						</div>
						<div class="services-icon-info">
						<a href="studentleaveform.jsp">	<h5>Apply Leave Form</h5></a>
							<p></p>
						</div>
					</div>
					<div class="col-sm-4 services-right-grid">
						<div class="services-icon hvr-radial-in">
						<a href="studentoutpass.jsp">
						<i class="fa fa-question-circle-o" aria-hidden="true"></i></a>
						</div>
						<div class="services-icon-info">
						<a href="studentoutpass.jsp">	
							<h5>Apply OutPass</h5></a>
							<p></p>
						</div>
					</div>
					<div class="clearfix"> </div>
