...
<form action="studentoutpass" method="post">
<table>
<tr>
...
<tr>
	...
	<td><select id="act" name="act">
		<option value="personal">Personal Activity</option>
		<option value="club">Club Activity</option>
		<option value="dep">Department Activity</option>
		</select>
	</td>
</tr>
<tr>
<td>
<label for="dep">Select Department/Club:</label></td>
