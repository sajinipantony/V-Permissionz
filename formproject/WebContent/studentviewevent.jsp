	...
	<div class="header-w3ls-agileinfo">
			...
			<div class="wthree_agile_top_header">
				<div class="logo-agileits">
					<h1><a ><span>A</span>NNS COLLEGE OF TECHNICAL ENGINEERING <i class="fa fa-graduation-cap" aria-hidden="true"></i></a></h1>
				</div>
...
<div class="services" id="services">
		...
		<center>		<p class="sub two"><%=date %> </p>
		<h3 class="h-two"><%=eventname %></h3> 
	 	<p class="sub two"> place : <%=hallname %> </p>
		</center>
			</div>
		...
		<div style="margin-left: 350px;">
					<p style="color: green"><%=dep %></p>
					<div class="clearfix"> </div>
				</div>
				</td>
				<td><img alt="" src="adminviewevents?id=<%=id %>" width="300px" height="300px"> </td>
				</tr>
				
				<tr height="30px">
				<td>
				<div style="margin-left: 350px;">
				<p style="color: blue"><i> </i></p>
				</div>
				</td>
				<td></td>
				</tr>
				...
				<td>
				<p style="color: blue"><i> Principal</i></p>
				</td>
				</tr>
				</table>
