...
<div class="contact" id="contact">
		<div class="container">
			...
			<div class="w3layouts-grids">
				...
				<div class="col-md-8 contact-form">
					<form action="watchman_chnge_pwd" method="get">
	...
	<font color="red">	Current Password: </font>
		<br>
		<input type="password" class="phone" name="cur_pwd"  required="" ">
		<br><br>
				<font color="red">New Password	: </font>
		<br>
		
					<input type="password" class="phone" name="new_pwd"  required="" >
					<br><br>
					<font color="red">	Confirm Password : </font>
		<br>
			
					<input type="password" class="phone" name="con_pwd"  required="" >
...
<!-- smooth scrolling -->
	...
	<script type="text/javascript">
			...
			if (window.location.href.indexOf("mismatch") > -1) {				
				swal({
					 title: "Password can't Updated!",
					  text: "Mismatch in Password.Please Try again!",
					  type: "error",
					  confirmButtonText: "OK"
					},
					function(isConfirm){
