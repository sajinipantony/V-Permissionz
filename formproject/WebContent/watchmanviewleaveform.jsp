	...
	<div class="header-w3ls-agileinfo">
			...
			<div class="wthree_agile_top_header">
				<div class="logo-agileits">
					<h1><a href="parent_homepg.jsp"><span>V</span>Permissionz.... <i class="fa fa-graduation-cap" aria-hidden="true"></i></a></h1>
				</div>
...
<div class="contact" id="contact">
		<div class="container">
			<div class="w3ls-heading">
				<h3><font color="red"> VIEW LEAVE FORM</font></h3>
...
try{
	...
	String date=null;
	String id=null;
String status="granded";

	Class.forName("com.mysql.jdbc.Driver");
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/project", "root","");
	Statement st=con.createStatement();
	rs=st.executeQuery("select * from outpass where status='"+status+"'");
	while(rs.next())
	{
		id=rs.getString(1);
